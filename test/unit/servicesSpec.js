    ...
    describe('dataset', function() {
      ...
      describe('all', function(){
        ...
        it('should return a promise', inject(function(dataset) {
          $httpBackend.whenGET('/api/v1/scorecard/charts').respond([]);
        ...
        it('should send a XHR requerest', inject(function(dataset) {
          ...
          $httpBackend.expectGET('/api/v1/scorecard/charts').respond([{key:0}]);
      ...
      describe('get', function(){
        ...
        it('should return a promise', inject(function(dataset) {
          $httpBackend.whenGET('/api/v1/scorecard/charts/0').respond({});
        ...
        it('should send a XHR requerest', inject(function(dataset) {
          ...
          $httpBackend.expectGET('/api/v1/scorecard/charts/0').respond(
